...
const translations = {
  cs: {
    ...
    'tour.tools.body': 'Začněte v aplikaci Umístění fotek (trať a mapa), pak pokračujte do Foto editoru. Data se mezi nimi předávají automaticky.',
  ...
  en: {
    ...
    'tour.tools.body': 'Start in Photo Placement (route & map), then move to the Photo Editor. Data passes between them automatically.',
